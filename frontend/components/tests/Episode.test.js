...
describe('Episode component', () => {
  ...
  test("renders texts and alt texts correctly", () => {
    ...
    expect(screen.getByText(exampleEpisodeData.summary))
    // 👉 TASK: check that the alt text "episode image" is present
    expect(screen.getByAltText('episode image'))
    ...
    expect(screen.getByAltText("generic episode image"))
    ...
    expect(screen.getByText('Loading episode...'))
  })
})
